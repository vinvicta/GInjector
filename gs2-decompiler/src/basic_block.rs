...
impl BasicBlockId {
    ...
    /// Example
    /// ```
    /// use gs2_decompiler::basic_block::BasicBlockId;
...
impl BasicBlock {
    ...
    /// Example
    /// ```
    /// use gs2_decompiler::basic_block::{BasicBlock, BasicBlockId, BasicBlockType};
    ///
    ...
    /// ```
    /// use gs2_decompiler::basic_block::{BasicBlock, BasicBlockId, BasicBlockType};
    /// use gs2_decompiler::instruction::Instruction;
    /// use gs2_decompiler::opcode::Opcode;
    /// use gs2_decompiler::operand::Operand;
    ///
